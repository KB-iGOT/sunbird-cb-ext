...
public class InsightsServiceImpl implements InsightsService {
    ...
    public SBApiResponse readInsightsForOrganisation(Map<String, Object> requestBody, String userId) {
        ...
        try {
            ...
            Map<String, String> organisationInsideFields = mapper.readValue(organisationInsideFieldsProperty, new TypeReference<Map<String, String>>() {
            });
            Map<String, String> redisKeyForInsight =  mapper.readValue(redisKeyForInsightsProperty, new TypeReference<Map<String, String>>() {
            });
            Map<String, String> cssPropertiesForInsight = mapper.readValue(cssPropertiesForInsightsProperty, new TypeReference<Map<String, String>>() {
            });
